...
_tl = (
  ...
  '<div class="tl-item">'
    ...
    '<div class="tl-body">'
      ...
      '<div class="tl-desc">From the garage, take the <strong>stairs to the ground floor (P/0)</strong>. From the main entrance, the apartment is on the <strong>ground floor to the right</strong>.</div>'
    '</div>'
  '</div>'
  '<div class="tl-item">'
...
f'<div class="garage-badge">'
f'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#148A46" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>'
f' Apartment on the ground floor'
f'</div>'
f'<p>The apartment keys and garage remote are stored in the key safe beside the garage entrance. Use the access code provided before arrival to open the safe and enter the garage area. The apartment is located on the ground floor to the right.</p>'
f'</div>'
