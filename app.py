...
_tl = (
  ...
  '<div class="tl-item">'
    ...
    '<div class="tl-body">'
      ...
      '<div class="tl-desc">From the garage, take the <strong>stairs to the ground floor (P/0)</strong>. From the main entrance, <strong>apartment number 5</strong> is on the <strong>ground floor to the right</strong>.</div>'
    '</div>'
  '</div>'
  '<div class="tl-item">'
  ...
  f'<div class="important-notice">'
    ...
    f'<div style="display:flex;gap:16px;align-items:center;margin-top:4px;">'
      f'<div style="flex:1;">'
        ...
        f'<p style="margin-top:12px;">Please note that the tourist tax is not included in the accommodation price and is <strong style="color:#fff;">payable separately</strong>, and should be <strong style="color:#fff;">settled before check-out</strong>.</p>'
      f'</div>'
...
f'<div class="garage-badge">'
f'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#148A46" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>'
f' Apartment 5 on the ground floor'
f'</div>'
f'<p>The apartment keys and garage remote are stored in the key safe beside the garage entrance. Use the access code provided before arrival to open the safe and enter the garage area. Apartment number 5 is located on the ground floor to the right.</p>'
f'</div>'
...
f'<div class="cl-item">{_chk_icon}<span>Please remember to leave the <strong>tourist tax payment</strong> in the apartment before your departure.</span></div>'
