  ...
  f'<div class="important-notice">'
    ...
    f'<div style="display:flex;gap:16px;align-items:center;margin-top:4px;">'
      f'<div style="flex:1;">'
        ...
        f'<p>Please note that the tourist tax is not included in the accommodation price and is <strong style="color:#fff;">payable separately</strong>, and should be <strong style="color:#fff;">settled before check-out</strong>.</p>'
      f'</div>'
