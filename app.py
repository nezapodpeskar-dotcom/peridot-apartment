...
<section id="welcome" class="pa-hero">
  ...
  <div class="pa-hero-right">
    {img_tag_sm(building, "Villa Mojca", "width:100%;height:580px;object-fit:cover;display:block;")}
...
f'{img_tag_sm(key_box_loc, "Key box location", "width:100%;height:auto;object-fit:contain;display:block;padding:16px;background:#f9fbf9;")}'
